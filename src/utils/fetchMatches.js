...
const football_matches = [
    {
        ...
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/en/thumb/4/47/FC_Barcelona_%28crest%29.svg/1200px-FC_Barcelona_%28crest%29.svg.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/1200px-Real_Madrid_CF.svg.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
        'place': 'Camp Nou',
        'date': '01.01.2023'
    },
    {
        ...
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/en/thumb/7/7a/Manchester_United_FC_crest.svg/1200px-Manchester_United_FC_crest.svg.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/en/thumb/0/0c/Liverpool_FC.svg/1200px-Liverpool_FC.svg.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
        'place': 'Old Trafford',
        'date': '02.01.2023',
    },
    {
        'team1_name': 'Juventus',
        'team2_name': 'Milan',
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/commons/c/c0/Juventus_FC.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Logo_of_AC_Milan.svg/1200px-Logo_of_AC_Milan.svg.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
    ...
    },
    {
        ...
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/1024px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/commons/7/74/Borussia_Dortmund.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
        'place': 'Allianz Arena',
        'date': '04.04.2023',
    },
    {
        ...
        'team2_name': 'Olympique Marseille',
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/ru/3/3d/FC_Paris_Saint-Germain_Logo.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Olympique_Marseille_logo.svg/1582px-Olympique_Marseille_logo.svg.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
    ...
    },
    {
        'team1_name': 'Chelsea',
        'team2_name': 'Arsenal',
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/ru/thumb/f/f7/FC_Chelsea_Logo.svg/1200px-FC_Chelsea_Logo.svg.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/hif/8/82/Arsenal_FC.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
    ...
    },
    {
        ...
        'team2_name': 'Borussia Monchengladbach',
        'team1_logo': 'https://upload.wikimedia.org/wikipedia/ru/f/fd/RB_Leipzig.png',
        'team2_logo': 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Borussia_M%C3%B6nchengladbach_logo.svg/1283px-Borussia_M%C3%B6nchengladbach_logo.svg.png',
        'team1_win_percentage': Math.floor(Math.random() * 90) + 10,
        'team2_win_percentage': Math.floor(Math.random() * 90) + 10,
